...
def run_experiments():
    noises = [0.1, 0.5, 0.9]
    alphas = [0.5]
    epsilons = [-1, 0.01, 0.05, 0.1, 0.5]
    init_temps = [10.0]
    temp_decrease_rates = [1.005, 1.05, 1.2]
                ...
                if epsilon == -1:
                    ...
                    for init_temp in init_temps:
                        for temp_decrease_rate in temp_decrease_rates:
                            run_expr(alpha=alpha, epsilon=epsilon, init_temp=init_temp, temp_decrease_rate=temp_decrease_rate, noise=noise)
                # epsilon greedy
                else:
                    run_expr(alpha=alpha, epsilon=epsilon, noise=noise)
