...
def runEpisode(agent, m_environment, discount, f_decision
    ...
    while True:
        ...
        if optimal_policy is not None and policy_converge_ratio_logs is not None:
                policy_convergence_ratio = getPolicyConvergenceRatio(m_environment
...
class TamerGridWorldExperiment():
    ...
    def run_episodes(self):
        ...
        try:
            self.display.displayQValues(self.agent, (0, 0), message="Q-VALUES AFTER " + str(self.n_episodes) + " EPISODES")
