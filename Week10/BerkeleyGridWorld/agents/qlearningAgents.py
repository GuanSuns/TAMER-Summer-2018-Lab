...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        q_learn_opts = {
            'gamma': ExperimentConfigurator.gridWorldConfig['discount'],
            'alpha': ExperimentConfigurator.qLearningConfig['learning_rate'],
            'epsilon': ExperimentConfigurator.qLearningConfig['epsilon'],
            'actionFn': args['actionFn']
        }
        ReinforcementAgent.__init__(self, **q_learn_opts)

        "*** YOUR CODE HERE ***"
        # the key of Q-Values should be (state, action)
        self.qValues = util.Counter()
        self.temperatures = dict()
        self.init_temp = ExperimentConfigurator.qLearningConfig['init_temp']
        self.temp_decrease_rate = ExperimentConfigurator.qLearningConfig['temp_decrease_rate']
        self.is_show_real_values = True
        #############################################################
        ##############  VDBE epsilon annealing   ####################
        #############################################################
        self.use_VDBE = ExperimentConfigurator.VDBEConfig['use_VDBE']
        self.VDBE_sigma = ExperimentConfigurator.VDBEConfig['sigma']
        self.VDBE_delta = ExperimentConfigurator.VDBEConfig['delta']
        self.episode_anneal_threshold = ExperimentConfigurator.VDBEConfig['episode_anneal_threshold']
        self.state_VDBE = dict()
        #############################################################
        ############  Episode-wise epsilon annealing   ##############
        #############################################################
        self.use_episode_epsilon_anneal = ExperimentConfigurator.EpisodeWiseEpsilonAnnealing['use_episode_epsilon_anneal']
        self.global_epsilon = ExperimentConfigurator.EpisodeWiseEpsilonAnnealing['global_epsilon']
        self.global_min_epsilon = ExperimentConfigurator.EpisodeWiseEpsilonAnnealing['global_min_epsilon']
        self.global_decay_rate = ExperimentConfigurator.EpisodeWiseEpsilonAnnealing['global_decay_rate']
        self.episode_init_epsilon = ExperimentConfigurator.EpisodeWiseEpsilonAnnealing['episode_init_epsilon']
        self.episode_decay_rate = ExperimentConfigurator.EpisodeWiseEpsilonAnnealing['episode_decay_rate']
...
class TamerQAgent(QLearningAgent):
    def __init__(self, **args):
        ...
        self.window_size = ExperimentConfigurator.TamerConfig['agent_window_size']
        self.is_asyn_input = ExperimentConfigurator.TamerConfig['is_asyn_input']
        self.max_n_experiences = ExperimentConfigurator.TamerConfig['agent_max_n_experiences']
